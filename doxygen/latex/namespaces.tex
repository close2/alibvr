...
\item\contentsline{section}{\hyperlink{namespacetasks}{tasks} \\*This file provides an elegant way to register tasks and execute them in your main loop }{\pageref{namespacetasks}}{}
\end{DoxyCompactList}
