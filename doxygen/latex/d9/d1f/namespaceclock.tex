...
the type of target\+\_\+clock must be big enough to represent {\ttfamily previous\+\_\+clock -\/ clock}.$\ast$
...
For instance the system clock value 300 and the target\+\_\+clock type uint8\+\_\+t would result in {\ttfamily 300 \% 256}, which is 44. \begin{DoxyVerb} @tparam T The type size used for clock comparisons.
 @param previous_clock Used to disambiguate wrapped clock values.
                       (See function description.)
 @param target_clock The target system clock value.\end{DoxyVerb}
